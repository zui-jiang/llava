...
deepspeed  --master_port 20522  llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-0.5b-pretrain-32/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-0.5b-32 \
    --num_train_epochs 1 \

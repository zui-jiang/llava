...
deepspeed  --master_port 22922 --include=localhost:1,2,3,4,5,6,7 llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /data5/liuyanjiang2021/checkpoints/llama3-chat-8b-pretrain/checkpoint-5/mm_projector.bin \

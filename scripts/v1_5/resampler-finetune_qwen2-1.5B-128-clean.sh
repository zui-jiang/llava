...
deepspeed  --master_port 20522  llava/train/train_mem.py \
    ...
    --pretrain_mm_mlp_adapter /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-1.5b-pretrain-128-clean/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-1.5b-128-clean \
    --num_train_epochs 1 \

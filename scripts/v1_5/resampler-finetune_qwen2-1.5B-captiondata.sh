...
deepspeed  --master_port 20522  llava/train/train_mem.py \
    ...
    --version qwen_2 \
    --data_path /ciphome/liuyanjiang2021/caption-llava-data/llava_v1_5_mix665k.json \
    --image_folder /data5/liuyanjiang2021/ \
    --vision_tower /data7/hf_models/openai/clip-vit-large-patch14-336 \
    --pretrain_mm_mlp_adapter /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-1.5b-pretrain-128/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-1.5b-captiondata \
    --num_train_epochs 1 \

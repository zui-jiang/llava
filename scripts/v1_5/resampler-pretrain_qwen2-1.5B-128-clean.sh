...
deepspeed --master_port 20522 llava/train/train_mem.py \
    ...
    --version qwen_2 \
    --data_path /ciphome/liuyanjiang2021/llava-toxinic/clean-data/clean-blip_laion_cc_sbu_241k.json \
    ...
    --bf16 True \
    --output_dir /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-1.5b-pretrain-128-clean \
    --num_train_epochs 1 \

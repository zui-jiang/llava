...
deepspeed --master_port 20121 llava/train/train_mem.py \
    ...
    --version qwen_2 \
    --data_path /home/liuyanjiang2021/LLaVA_Data/LLaVA-Pretrain/blip_laion_cc_sbu_558k.json \
    --image_folder /home/liuyanjiang2021/LLaVA_Data/LLaVA-Pretrain/images \
    ...
    --bf16 True \
    --output_dir /home/liuyanjiang2021/resampler-llava-qwen2instruct-1.5b-pretrain-1 \
    --num_train_epochs 1 \

...
export WANDB_PROJECT=LLaVA-Qwen2-7B
export WANDB_NAME=resampler-if-Qwen2-7B${EXP_ID}

deepspeed  --master_port 20522  llava/train/train_mem.py \
    --deepspeed scripts/zero3.json \
    --model_name_or_path /data5/liuyanjiang2021/hf_models/Qwen2-7B-Instruct \
    --version qwen_2 \
    ...
    --pretrain_mm_mlp_adapter /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-7b-pretrain-256/mm_projector.bin \
    ...
    --bf16 True \
    --output_dir /data5/liuyanjiang2021/checkpoints/resampler-llava-qwen2instruct-7b-256 \
    --num_train_epochs 1 \
